...
train_words_list1,train_labels1 = loadfile('./Python/geekDA/text classification/train/女性','女性')
train_words_list2,train_labels2 = loadfile('./Python/geekDA/text classification/train/体育','体育')
train_words_list3,train_labels3 = loadfile('./Python/geekDA/text classification/train/文学','文学')
train_words_list4,train_labels4 = loadfile('./Python/geekDA/text classification/train/校园','校园')
train_words_list = train_words_list1 + train_words_list2 + train_words_list3 + train_words_list4
train_labels = train_labels1 + train_labels2 + train_labels3 + train_labels4

test_words_list1,test_labels1 = loadfile('./Python/geekDA/text classification/test/女性','女性')
test_words_list2,test_labels2 = loadfile('./Python/geekDA/text classification/test/体育','体育')
test_words_list3,test_labels3 = loadfile('./Python/geekDA/text classification/test/文学','文学')
test_words_list4,test_labels4 = loadfile('./Python/geekDA/text classification/test/校园','校园')
test_words_list = test_words_list1 + test_words_list2 + test_words_list3 + test_words_list4
test_labels = test_labels1 + test_labels2 + test_labels3 + test_labels4
# Python\geekDA\text classification\stop
stop_words = open ('./Python/geekDA/text classification/stop/stopword.txt','r',encoding='utf-8').read()
